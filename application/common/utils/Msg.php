...
class Msg
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = config('msg.accessKeyId');
        $accessKeySecret = config('msg.accessKeySecret');
    ...
    public static function sendSms($phone,$code) {
        //短信签名  
        $signName = config('msg.signName');
        $templateCode = config('msg.templateCode'); // 注册登录短信验证码模板
